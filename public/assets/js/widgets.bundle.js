                    ...
                    var t,
                        a = function () {
                            ...
                            var f,
                                ...
                                p = g.series.push(am5map.MapPolygonSeries.new(t, { fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-300")), geoJSON: am5geodata_usaLow }));
                            p.mapPolygons.template.setAll({ tooltipText: "{name}", interactive: !0 }),
                                p.mapPolygons.template.states.create("hover", { fill: am5.color(KTUtil.getCssVariableValue("--bs-success")) }),
                                p.mapPolygons.template.states.create("active", { fill: am5.color(KTUtil.getCssVariableValue("--bs-success")) }),
...
var KTTablesWidget16 = (function () {
    ...
    return {
        init: function () {
            ...
            v(p, "#kt_stats_widget_16_tab_link_4", "#kt_table_widget_16_chart_4_4", O, !1);
            var F = [5, 10, 15, 21, 6, 11, 5, 23, 5, 11, 17, 7, 21, 13];
            v(h, "#kt_stats_widget_16_tab_link_5", "#kt_table_widget_16_chart_5_1", F, !1);
            ...
            v(b, "#kt_stats_widget_16_tab_link_5", "#kt_table_widget_16_chart_5_4", R, !1),
                KTThemeMode.on("kt.thememode.change", function () {
                    e.rendered && e.self.destroy(),
                        ...
                        v(p, "#kt_stats_widget_16_tab_link_4", "#kt_table_widget_16_chart_4_4", O, p.rendered),
                        v(h, "#kt_stats_widget_16_tab_link_5", "#kt_table_widget_16_chart_5_1", F, h.rendered),
